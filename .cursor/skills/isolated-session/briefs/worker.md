...
4. Do the task below. Run each test file you change or add directly (`python3 test_x.py`), then `python3 tools/run_tests.py --affected main..HEAD -j4` from the worktree. Do not run two test suites at once.
